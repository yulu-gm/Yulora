...
- 可以改颜色、材质、边框、阴影、滤镜
- 主题可以依赖公开 surface hook，例如 `[data-fishmark-surface="settings-drawer"]`、`[data-fishmark-surface="titlebar"]`
- 不要依赖 settings drawer、titlebar 的 shell-private class selector；这些 class 只是 renderer 实现细节，不属于主题合同
